...
* You can submit bug reports, questions or suggestions on `kobe` at the `kobe` issue page ^[<https://github.com/flr/kobe/issues>], or on the *FLR* mailing list.
* Or send a pull request to <https://github.com/flr/kobe/>
* For more information on the FLR Project for Quantitative Fisheries Science in R, visit the FLR webpage ^[<http://flr-project.org>].
* The latest version of `kobe` can always be installed using the `devtools` package, by calling
