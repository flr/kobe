#' @importFrom melt cast
#' @importFrom plyr mlply llply

# setMethod('read.kobe',  signature(object='character',method="character"), 
#           function(object,
...
#                    year  =NULL,
#                    nwrms =10,...){
#           warning("kobe will be replaced by 'read.kobe' in later releases")
#             
#           read.kobe(object,method,what,dir,prob,year,nwrms,...)})
# 
